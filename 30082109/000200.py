# Nivelación MCOC,
"""
Durante esta nivelación se aprende cómo graficar listas en python, estas listas son asignadas a una variable 
dentro de un gráfico se pueden representar varias funciones o relaciones entre listas 
casa gráfico pude tener su propio nombre y cambiar el estilo de líne, color y marcas de datos
se puden crear todas las funciones o instrucciones para crear un gráfico que uno quiera, así como las listas a estudiar
"""
...
plt.show() #permite mostrar gráfico obtenido en consola
#esta instrucción va al final de todas las especificaciones
